...
return [
    ...
    */
    ...
    'project_logo'   => '<b>La Boîte à </b>&nbsp;Pizza',
    ...
    // For background colors use: bg-dark, bg-primary, bg-secondary, bg-danger, bg-warning, 
    //bg-success, bg-info, bg-blue, bg-light-blue, bg-indigo, bg-purple, bg-pink, bg-red, 
    //bg-orange, bg-yellow, bg-green, bg-teal, bg-cyan, bg-white
    ...
    'sidebar_class' => 'sidebar bg-secondary sidebar-pills',
    ...
    'footer_class' => 'app-footer  bg-purple',
    // hide it with d-none
    // change background color with bg-dark, bg-primary, bg-secondary, bg-danger, bg-warning,
